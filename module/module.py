...
class Module(object):
    ...
    def grad_cam(self, dx, requires_activation):
        ...
        dx, x = self._grad_cam(dx, requires_activation)
        return dx, x
    ...
    def lrp(self, R, labels, lrp_var=None,param=None):
        '''
        ...
        if lrp_var is None or lrp_var.lower() == 'none' or lrp_var.lower() == 'simple':
            Rx = self._simple_lrp(R, labels)
            return Rx
        elif lrp_var.lower() =='composite':
            return self._composite_lrp(R, labels)
        elif lrp_var.lower() =='new_composite':
            return self._composite_new_lrp(R, labels)
        elif lrp_var.lower() == 'epsilon':
            return self._epsilon_lrp(R, param)
        elif lrp_var.lower() == 'alphabeta' or lrp_var.lower() == 'alpha':
            return self._alphabeta_lrp(R, labels)
        else:
