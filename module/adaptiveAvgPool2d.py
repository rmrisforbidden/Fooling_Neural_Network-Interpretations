...
from module._jit_internal import weak_module, weak_script_method
...
class AvgPool2d(_AvgPoolNd):
    ...
    def _composite_lrp(self, R, labels):
        ...
        x_p = torch.where(self.input<0, torch.zeros(1).cuda(), self.input)
        x_n = self.input - x_p
        ...
        return (1-args.beta) * x_p*RdivZp_interpol + args.beta * x_n*RdivZn_interpol
...
#         return R
        ...
        return (1-args.beta) * Rx_p + (args.beta * Rx_n)
