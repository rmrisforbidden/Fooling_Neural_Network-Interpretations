        ...
        for i, data in enumerate(train_loader):
            ...
            if itr % args.eval_period  == 0:
                ...
                if args.imagenet_accuracy:
                    print('!!!!!!!!!!!!  test mode is false. Change it to True when you push code in git!!!!!!!!!!!!!!!!')
                    test_acc1, test_acc5, loss_dict = test_accuracy(net, test_loader, num_data=250, get_quanti ='loss', loss_dict = loss_dict, net_ori = net_ori, test_mode=False, interpreter_list=interpreter_list)
